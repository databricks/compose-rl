...
_DATASET_PATH = 'dbfs:/Volumes/datasets/ashutoshbaheti/orl_data/open_r1_filtered/dpsk_8b_open_r1_48k/'
_HF_MODEL_NAME = 'deepseek-ai/DeepSeek-R1-Distill-Llama-8B'
_EXPT_NAME = 'test_single_controller_grpo_dpsk_l8b'
_EOS_TOKEN_IDS = [128001,128008,128009]
_PAD_TOKEN = '<|finetune_right_pad_id|>'
_MAX_SEQ_LEN = 10240
_MAX_GEN_LEN = 8192
