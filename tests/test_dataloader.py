...
def test_get_num_tokens_with_action_mask_and_prompt_len():
    ...
    batch = {
        'sequences': torch.tensor([
            [1, 2, 3, 4, 10, 11, 12, 0, 0],  # prompt: [1,2,3,4], generated: [10,11,12], padding: [0,0]
            [5, 6, 7, 8, 20, 21, 0, 0, 0]   # prompt: [5,6,7,8], generated: [20,21], padding: [0,0,0]
        ]),
        'prompt_len': torch.tensor([4, 4]),  # Both prompts are 4 tokens
