...
def policy_loss(
    ...
    if loss_type in ALGORITHM_TYPE.CLIPPED_PG:
        ...
        batch_action_mask = batch['action_mask']
        assert token_entropies.shape == batch_action_mask.shape, (
            f'Token entropies shape {token_entropies.shape} does not match action mask shape {batch_action_mask.shape}.',
        )
