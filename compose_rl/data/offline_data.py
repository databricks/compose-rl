...
def offline_dataset_collate_fn_test(
    ...
    batch_input_ids = [item['input_ids'] for item in data]
    ...
    for sample in data:
        ...
        if pad_len < 0:
            ...
            sequence_len = torch.tensor([len(input_ids)]) # TODO: check this line of code, len(sequence_len) should be one??
            pad_len = max_seq_len - sequence_len # TODO: so if it truncted, then pad_len = 1 in this case? 
