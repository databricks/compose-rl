...
class AsyncEngine:
    ...
    @staticmethod
    def construct_engine_from_args(*args: Any, **kwargs: Any) -> vllm.AsyncLLMEngine:
...
async def test_async_llm_pause_continue(async_llm: AsyncEngine, tokenizer: Any):
...
async def test_async_llm_abort(async_llm: AsyncEngine, tokenizer: Any):
...
async def test_async_llm(async_llm: AsyncEngine, tokenizer: Any):
...
def run_async_llm_test(async_llm: AsyncEngine, tokenizer: Any):
...
def run_async_llm_pause_continue_test(async_llm: AsyncEngine, tokenizer: Any):
...
def run_async_llm_abort_test(async_llm: AsyncEngine, tokenizer: Any):
